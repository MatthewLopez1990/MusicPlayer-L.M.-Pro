...
final class AudioEngineManager: ObservableObject {
    ...
    func seek(to time: TimeInterval) {
        ...
        // New playback session for the seek segment
        let sessionID = UUID()
        self.playbackSessionID = sessionID
        ...
        // Update offset for time calculation
        seekOffset = time
    ...
    private func updateProgress() {
        ...
        let timeSinceSchedule = currentSample / sampleRate
        
        // Calculate absolute time
        let newTime = seekOffset + timeSinceSchedule
